    ...
    <main className="min-h-screen max-w-[100rem] mx-auto">
      <div className="px-12 pt-12 pb-20">
        <div className="flex flex-col xl:flex-row gap-2 xl:gap-40">
          <div className="pt-12">
            <h2 className="text-4xl mb-16">РЕКОМЕНДУЕМ</h2>
            <p className="text-xl">Если хотите, чтобы ваш товар попал сюда...</p>
          </div>
        ...
        <h2 className="text-4xl mt-20 mb-16">ВСЕ ТОВАРЫ</h2>
        {products && products.length > 0 ? (
          ...
          <p className="text-xl text-gray-800">Все наши товары пропали :(</p>
        )}
      </div>
    </main>
  );
