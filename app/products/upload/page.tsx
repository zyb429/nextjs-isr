...
const UploadFormPage: React.FC = () => {
  ...
  return (
    <div className="px-12 pt-24 pb-12 min-h-screen max-w-[100rem] mx-auto flex gap-56">
      ...
      <div className="mx-auto w-full h-full p-12 rounded-lg border-2 border-gray-500 border-opacity-10 shadow-lg bg-slate-400">
        {state?.type === 'error' && (
        ...
        <form action={formAction}>
          ...
          <div className="mb-6 object-cover">
            <label htmlFor="image" className="block  mb-2">
              Image (name should contain only latin letters)
            </label>
