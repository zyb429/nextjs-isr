    ...
    <div className="px-12 py-12 max-w-7xl mx-auto min-h-screen">
      ...
      <div className="flex flex-col lg:flex-row gap-4 lg:gap-6 mb-4">
        <div className="flex items-center justify-center">
          <Image
            className="rounded-lg shadow-xl border-4 border-gray-300 p-2 lg:min-w-[40rem] lg:min-h-[30rem]"
            width={600}
            height={600}
            alt={data.name}
        ...
        <div className="bg-neutral-300 rounded-lg p-6 w-full">
          <label className="font-bold">💰 PRICE:</label>
          <p className="text-gray-800 text-2xl lg:text-3xl pt-4 py-6 text-right border-b-2 decoration-dotted border-dashed border-gray-800 border-opacity-15">
            ${data.price}
          </p>
          ...
          {data.boost && (
            <div className="pt-4" >
              ...
              <p className="text-gray-800 text-2xl lg:text-3xl py-6 text-right border-b-2 decoration-dotted border-dashed border-gray-800 border-opacity-15">
                Yes
              </p>
            </div>
          )}
